import{a as e,d as t,f as n,i as r,m as i,n as a,o,r as s,s as c,t as l}from"./index-Cx41wXWG.js";import{t as u}from"./Block-Bx8Br3nx.js";import{t as d}from"./Chip-BR_qNVjf.js";var f=c();function p({url:e,containerClassOverride:t,videoClassOverride:n,loop:r}){return(0,f.jsx)(`div`,{className:`overflow-hidden bg-black ${t||`shadow-2xl max-w-3xl mx-auto my-8 rounded-xl`}`,children:(0,f.jsxs)(`video`,{className:`w-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-full max-w-none pointer-events-none object-cover aspect-video ${n}`,loop:r,muted:!0,autoPlay:!0,playsInline:!0,children:[(0,f.jsx)(`source`,{src:e,type:`video/mp4`}),`Your browser does not support the video tag.`]},e)})}var m={heroTitle:`Engineering experiences that leave a mark`,heroSubtitle:`in your hearts? Maybe. Here at GravenSoft, our team is committed to delivering you quality software solutions that scale.`,testTitle:`Lorem Ipsum`,testTest:`dolor sit amet, consectetur adipiscing elit. Quisque vel magna nec nulla sollicitudin consectetur.
    ...
    Nam faucibus tincidunt est at efficitur.`},h=``+new URL(`background-CR8D3S_n.mp4`,import.meta.url).href,g=i(n((e=>{function n(e){if(!e||typeof window>`u`)return;let t=document.createElement(`style`);return t.setAttribute(`type`,`text/css`),t.innerHTML=e,document.head.appendChild(t),e}Object.defineProperty(e,"__esModule",{value:!0});var r=t();function i(e){return e&&typeof e==`object`&&`default`in e?e:{default:e}}var a=i(r);n(`.rfm-marquee-container {
  overflow-x: hidden;
  display: flex;
  flex-direction: row;
  position: relative;
